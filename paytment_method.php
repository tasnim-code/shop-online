...
<head>
   ...
   <title>shopping cart \ سلة التسوق</title>
...
<section class="products shopping-cart">
  ...
  <form action="" method="post" class="box">
      ...
      <div class="flex">
         <div class="price" style="color:red;">ريال عماني<?= $fetch_cart['price']; ?></div><br>
   ...
   <div class="cart-total">
      ...
      <a href="checkout.php" class="option-btn">الدفع عند الاستلام</a>
      ...
      <a href="visa.php" class="btn <?= ($grand_total > 1)?'':'abled'; ?>">الدفع ببطاقة البنك</a>
   </div>
